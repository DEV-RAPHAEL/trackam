    ...
    <div className="flex h-screen overflow-hidden bg-slate-50 font-sans text-slate-900">
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        {currentCompany?.subscription_status === 'trialing' && (
          <div className="bg-emerald-600 text-white px-4 py-2 flex items-center justify-center gap-3 text-sm font-medium shadow-lg z-50">
        ...
        <header className="h-[64px] bg-white border-b border-slate-200 flex items-center justify-between px-8 shrink-0">
          ...
          <div className="flex items-center gap-4">
            <div className="relative">
              <input type="text" placeholder="Search anything..." className="w-64 pl-9 pr-4 py-1.5 bg-slate-100 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/20 transition-all" />
